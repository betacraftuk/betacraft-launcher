...
InstanceEditAppearanceWidget::InstanceEditAppearanceWidget(QWidget* parent)
    ...
    _instanceGameFullscreenCheckbox->setText(bc_translate("instance_game_fullscreen"));
...
void InstanceEditAppearanceWidget::setInstance(bc_instance instance) {
    ...
    _instanceGameWidthTextbox->setText(QString::number(instance.width));
    _instanceGameHeightTextbox->setText(QString::number(instance.height));
