...
public class Version extends JFrame implements ActionListener {
	...
	static String internal_err = "An internal error has occurred.";
	...
	public Version() {
		...
		String name = (Version.order == Order.FROM_OLDEST) ? Lang.get("sort_oldest") : Lang.get("sort_newest");
		if (name.equals("")) {
			name = Version.order == Order.FROM_OLDEST ? "Sort: from oldest" : "Sort: from newest";
		}
		...
		sort_button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (Version.order == Order.FROM_OLDEST) {
					Version.order = Order.FROM_NEWEST;
					sort_button.setText(Lang.get("sort_newest"));
				} else {
					Version.order = Order.FROM_OLDEST;
		...
		date = new JLabel(Version.release);
	...
	public void saveVersion() {
		...
		Window.selectedVersionDisplay.setText(ver.getName());
