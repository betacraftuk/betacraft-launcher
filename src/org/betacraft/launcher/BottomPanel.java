...
public class BottomPanel extends JPanel {
	...
	public BottomPanel() {
		...
		//setMaximumSize(new Dimension(8192, 200)); // replace 140 with 450 in case you want to go back
		...
		//constr.ipadx = GridBagConstraints.HORIZONTAL;
		constr.gridx = 0;
